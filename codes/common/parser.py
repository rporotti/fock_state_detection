...
parser.add_argument('--T_max', type=float, default=25.0, help='Physical max time in ns (default 30 )')
...
parser.add_argument('--meas_rate', type=float, default=1.0, help='Measurement rate (default at 0)')
...
parser.add_argument('--multiplier', type=float, default=25.0*100, help='Multiplier for action')
